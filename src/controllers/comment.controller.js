...
const addComment = asyncHandler1(async (req, res) => {
...
const getVideoComments = asyncHandler1(async (req, res) => {
...
const updateComment = asyncHandler1(async (req, res) => {
...
const deleteComment = asyncHandler1(async (req, res) => {
  const { commentId } = req.params;
  const userId = req.user._id;
