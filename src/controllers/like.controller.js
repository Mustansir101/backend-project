...
const toggleVideoLike = asyncHandler1(async (req, res) => {
...
const toggleCommentLike = asyncHandler1(async (req, res) => {
...
const toggleTweetLike = asyncHandler1(async (req, res) => {
...
const getLikedVideos = asyncHandler1(async (req, res) => {
  const userId = req.user._id;
